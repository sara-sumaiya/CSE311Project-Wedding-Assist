...
<body>
    <div class="container">
        <h1 class="headline"><mark>Makeup Artists</mark></h1>
        <?php
        include('pages/connection.php');
        $view_users_query = "select * from vendors join makeup_artists where vendors.Email = makeup_artists.Vendors_mA_Email;";
