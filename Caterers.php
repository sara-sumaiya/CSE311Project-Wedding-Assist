...
<body>
    <div class="container">
        <h1 class="headline"><mark>Catering Services</mark></h1>
        <?php
        include('pages/connection.php');
        $view_users_query = "select * from vendors join Caterers where Vendors.Email = Caterers.Vendors_cat_Email;";
          ...
          <div class="col-sm">
            <div class="card" style="width: 18rem, height 10rem;">
                ...
                <h2><?=$Business_Name?></h2>
                  ...
                  <h6><?=$vemail?></h6><br>
                  &nbsp;&nbsp;
                  <a href="book.php"><button class='btn1' >Contact for Discussion</button></a>
                  <hr><ht><hr>
                </div>
              </div>
          </div>
