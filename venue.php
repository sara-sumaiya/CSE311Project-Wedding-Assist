...
<body>
    <div class="container">
        <h1 class="headline"><mark>Venue</mark></h1>
        <?php
        include('pages/connection.php');
        $view_users_query = "select * from vendors join Venues where vendors.Email = Venues.Vendors_ven_Email;";
