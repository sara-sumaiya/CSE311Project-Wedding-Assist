...
<body>
    <div class="container">
        <h1 class="headline"><mark>Decorators</mark></h1>
        <?php
        include('pages/connection.php');
        $view_users_query = "select * from vendors join Decorators where Vendors.Email = Decorators.Vendors_dec_Email;";
